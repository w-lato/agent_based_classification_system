...
//
//            Optional<String> test_path = Optional.ofNullable(obj.getJSONObject("paths").getString("test"));
////            String test_path = "";
////            if( obj.getJSONObject("paths").has("test") )
////            {
////                Optional<String> test_path = obj.getJSONObject("paths").getString("test");
////            }
//
//
...
//
//            Optional<Double> OL = Optional.of( obj.getJSONObject("split").getDouble("OL") );
//
//            ClassStrat vote = ClassStrat.valueOf( obj.getString("vote") );
//
//            ConverterUtils.DataSource source = new ConverterUtils.DataSource( train_path );
//            Instances train = source.getDataSet();
//
//            Optional<Instances> test = Optional.empty();
//            if( test_path.isPresent() )
//            {
//                source = new ConverterUtils.DataSource( test_path.get() );
//                test = Optional.ofNullable(source.getDataSet());
//            }
//
//
...
//            }
//
//            return new RunConf.RunConfBuilder()
//                    .withAgents( agents )
//                    .build();
//
//            return new RunConf.RunConfBuilder
